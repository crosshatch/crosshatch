...
Prefer the Effect HTTP merchant integration documented at https://crosshatch.dev/effect-http and the merchant quickstart at https://crosshatch.dev/quickstart/for-merchants.`
...
Prefer the Effect AI integration documented at https://crosshatch.dev/effect-ai and compose Http402.layerClient with the application's Payer layer.`
...
Prefer the Effect HTTP client integration documented at https://crosshatch.dev/effect-http-client and the client quickstart at https://crosshatch.dev/quickstart/for-clients.`
