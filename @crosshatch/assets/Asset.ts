...
export const findByX402 = (chainId: string, x402Asset: string, assets: ReadonlyArray<Asset>): Asset | undefined =>
  assets.find((asset) => asset.chainId === chainId && asset.address.toLowerCase() === x402Asset.toLowerCase())
